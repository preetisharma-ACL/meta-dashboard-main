...
export default function Header() {
    ...
    onMount(() => {
        const handleOutsideClick = (e) => {
            ...
            if (!e.target.closest(".header-notifications")) setShowNotifications(false);
        };
                                ...
                                <div class="max-h-96 overflow-y-auto">
                                    ...
                                    >
                                        <For each={notifications()}>
                                            {(notif) => (
                                                <div class={`p-4 border-b border-gray-100 dark:border-gray-700 hover:bg-blue-50 dark:hover:bg-gray-700 cursor-pointer transition-colors ${notif.unread ? 'bg-gray-50 dark:bg-blue-900/10' : ''}`}>
                                                    <div class="flex items-start gap-3">
                                                        <div class={`w-2 h-2 rounded-full mt-2 flex-shrink-0 ${notif.unread ? 'bg-blue-800' : 'bg-gray-300'}`} />
                                                        <div class="flex-1 min-w-0">
                                                            <h4 class="text-sm font-medium text-blue-800 dark:text-white truncate">{notif.title}</h4>
                                                            <p class="text-xs text-gray-700 dark:text-gray-400 mt-1 line-clamp-2">{notif.message}</p>
                        ...
                        >
                            ...
                            <div class="hidden md:block text-left">
                                ...
                                >
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">{user()?.organization_name}</p>
                                </Show>
                            </div>
