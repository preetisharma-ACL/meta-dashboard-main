...
export default function CampaignDetails() {
    ...
    return (
        <div class="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
            ...
            <nav>
                <ul class="flex items-center gap-1.5 mb-6 mt-2 list-none p-0">
                    <li class="flex items-center gap-1 group cursor-pointer">
                        ...
                        <a href="/" class="text-sm text-gray-600 dark:text-gray-400 transition-colors group-hover:text-purple-600">
                            Home
                        </a>
                    </li>
                    ...
                    <li class="flex items-center gap-1 group cursor-pointer">
                        <a href="/all-campaigns" class="text-sm text-gray-600 dark:text-gray-400 transition-colors group-hover:text-purple-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
                    <div class="p-5 border-b border-gray-200 dark:border-gray-700">
                        <h2 class="font-semibold text-gray-800 dark:text-white">Campaign Basics</h2>
                    </div>
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="p-4 md:font-medium text-sm dark:text-white">
                                    {campaign()?.name?.split("|")?.filter((_, i) => i < 2)?.join(" | ")}
                                </td>
                            </tr>
                            <tr class="border-b dark:border-gray-700">
                                <td class="p-4 text-gray-500 dark:text-gray-400 flex items-center gap-2">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
                    ...
                    <table class="w-full text-sm">
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                <td class="p-4 text-gray-500 dark:text-gray-400 flex items-center gap-2">
                                    <Eye size={16} class="text-gray-400 dark:text-gray-300" /> Impressions
                                </td>
                                <td class="p-4 font-medium dark:text-white">{campaign()?.impressions}</td>
                            </tr>
                            <tr class="border-b dark:border-gray-700">
                                <td class="p-4 text-gray-500 dark:text-gray-400 flex items-center gap-2">
                                    <Users size={16} class="text-gray-400 dark:text-gray-300" /> Reach
                                </td>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
                <div class="p-5 border-b border-gray-200 dark:border-gray-700">
                    <h2 class="font-semibold text-gray-800 dark:text-white">Audience & Targeting</h2>
                </div>
                <table class="w-full text-sm">
                    <tbody>
                        <tr class="border-b dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                            <td class="p-4 text-gray-500 dark:text-gray-400 flex items-center gap-2">
                                <Users size={16} class="text-gray-400 dark:text-gray-300" /> Age Group
                            </td>
                            <td class="p-4 font-medium dark:text-white">{campaign()?.age}</td>
                        </tr>
                        <tr class="border-b dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                            <td class="p-4 text-gray-500 dark:text-gray-400 flex items-center gap-2">
                                <User size={16} class="text-gray-400 dark:text-gray-300" /> Gender
                            </td>
