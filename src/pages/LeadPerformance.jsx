    ...
    return (
        <div class="p-4 md:p-6 min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200">
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
                <div>
                    <h1 class="text-2xl md:text-2xl font-semibold mb-1">Leads Performance</h1>
                        ...
                        <For each={filteredLeads()}>
                            {(lead, index) => (
                                <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition
                                    ...
                                    <td class="p-3">
                                        <span class={`px-2 py-1 rounded ${getStatusStyle(normalizeStatus(lead.status))}`}>
                ...
                isEditOpen() && (
                    <div class="fixed inset-0 z-50 flex">
                        ...
                        <div class="ml-auto w-full md:w-[600px] h-full bg-white dark:bg-gray-900 shadow-xl p-8 relative z-10 transition">
                            <h2 class="text-lg font-semibold mb-2">Edit Lead Performance</h2>
                            ...
                            <div class="space-y-3 border rounded p-6 bg-gray-50 dark:bg-gray-900">
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-5">
                                    <div>
                                        <label class="text-md text-gray-600 dark:text-gray-400 mb-1">Email</label>
                                        <input
                                    ...
                                    <div>
                                        <label class="text-md text-gray-600 dark:text-gray-400 mb-1">Created At</label>
                                        <input
                                            value={selectedLead()?.created}
                                            type="date"
                                            onInput={(e) =>
                                                setSelectedLead({ ...selectedLead(), created: e.target.value })
                                            }
                                            class="w-full p-2 border rounded dark:bg-gray-800"
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-5">
                                    ...
                                    <div>
                                        <label class="text-md text-gray-600 dark:text-gray-400 mb-1">Source</label>
                                        <input
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-5">
                                    <div>
                                        <label class="text-md text-gray-600 mb-2">Performance</label>
                                        <input
                                            value={selectedLead()?.performance}
                                            onInput={(e) =>
                                                setSelectedLead({ ...selectedLead(), performance: e.target.value })
                                            }
                                            class="w-full p-2 border rounded dark:bg-gray-800"
