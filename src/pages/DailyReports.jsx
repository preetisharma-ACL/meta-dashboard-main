...
export default function DailyReports() {
  ...
  const totals = createMemo(() => {
    ...
    const totalSpentGST = parseFloat(
      rows.reduce((s, r) => s + r.spentWithGST, 0).toFixed(2),
    );
    const avgCPL =
            ...
            <table class="w-full text-sm border-collapse">
              <thead>
                <tr class="bg-[#7B1C1C]">
                  ...
                  <th class="px-4 py-3 text-center text-[#f5d9a0] text-md  uppercase font-semibold">
                    Amount Spent (GST)
                  </th>
                </tr>
              </thead>
                ...
                <For each={reportRows()}>
                  {(row, i) => (
                    ...
                    >
                      ...
                      {/* GST — warm gold tint */}
                      <td
                        class="px-4 py-3 text-center font-semibold text-[#6b4c10] text-md"
              ...
              <tfoot>
                <tr class="bg-[#7B1C1C]">
                  ...
                  <td class="px-4 py-3 text-center text-[#f5d9a0] font-bold text-md">
                    {fmt(totals().totalSpentGST)}
                  </td>
                </tr>
              </tfoot>
              ...
              <table style="width:100%;border-collapse:collapse;font-family:Arial;">
                ...
                <tbody>
                  ...
                  <tr style="background:#7B1C1C;">
                    ...
                    <td style="padding:11px 14px;text-align:center;color:#f5d9a0;font-size:14px;font-weight:700;">
                      {fmt(totals().totalSpentGST)}
                    </td>
                  </tr>
                </tbody>
